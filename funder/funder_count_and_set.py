#this code is used to get all unique funder names and their counts appears to fund brandeis article in a given year range.
# THIS SCRIPT TAKES ABOUT 5 MIN TO RUN (if parameter is 2018 - 2024)
